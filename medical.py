...
# Streamlit UI setup
st.set_page_config(page_title="Dr. Jarvis", layout="centered")
st.title("🩺 I am Dr. Jarvis - Your Medical Image Analysis Tool 🔬")
st.markdown(
    """
    Welcome to the **Medical Image Analysis** tool! 📸
    Upload a medical image (X-ray, MRI, CT, Ultrasound, etc.), and the AI-powered system will analyze it, providing you detailed findings, diagnosis, and research insights.
    Let's get started!
    """
)
